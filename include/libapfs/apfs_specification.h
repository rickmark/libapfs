...
#ifndef LIBAPFS_APFS_SPECIFICATION_H
#define LIBAPFS_APFS_SPECIFICATION_H
...
#define APFS_INODE_PINNED_MASK            (INODE_PINNED_TO_MAIN \
                                          | INODE_PINNED_TO_TIER2)
...
#define APFS_FV_PERSONAL_RECOVERY_KEY_UUID \
